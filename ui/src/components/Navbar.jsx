...
import ExitRegistrationButton from './ExitRegistrationButton';
import TokenStatus from './TokenStatus';
import { handleManualLogout } from '@/utils/logoutUtils';
...
/* {
    ...
    "FirstName": "Jayant",
    "LastName": "Roy",
    "PersonalEmail": "codewithroy22@gmail.com",
    "WorkEmail": "jayanta@chandrakala.co.in",
    "PhoneNumber": "8400019683",
    "Address": "Dev Nagar Colony , Jhusi , Prayagraj",
    "EmergencyContact": "Ranjana Roy Choudhury",
    "EmergencyContactNumber": "8318048751",
    "DateOfBirth": "2025-08-07T08:52:26.738",
    "Gender": "Male",
    "DateOfJoining": "2025-08-07T08:52:26.738",
    "OBStatus": true,
    "IsActive": true,
    "ProfilePicture": "/ProfilePictures/JAYA1_PP.png",
    "Signature": null,
    "RoleID": 2
}
*/
    ...
    >
      <div className="flex items-center justify-between lg:px-6 lg:py-1.5 ">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Exit Registration Button */}
          <ExitRegistrationButton />
            ...
            >
              <div className="w-8 h-8 bg-slate-100 border border-gray-200 rounded-full flex items-center justify-center">
                {currentEmployee?.ProfilePicture ? (
                  <img src={`${baseFileURL}${currentEmployee?.ProfilePicture}`} alt="" className='rounded-full object-cover w-full h-full' />
                ) : (
                  <FiUser/>
                )}
              </div>
              <div className="hidden sm:block">
                <p className="text-sm font-medium text-gray-900">
                  {empLoading ? 'Loading...' : getEmployeeDisplayName()}
                </p>
                <p className="text-xs text-gray-500">
                  {currentEmployee?.WorkEmail || user?.email || 'Administrator'}
                </p>
              </div>
              <motion.i
              ...
              {profileDropdownOpen && (
                ...
                >
                  ...
                  <div className="px-4 py-3 border-b border-gray-100">
                    ...
                    <p className="text-xs text-gray-500">
                      {currentEmployee?.WorkEmail || user?.email || 'admin@example.com'}
                    </p>
