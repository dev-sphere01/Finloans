...
const AddRole = ({ onRoleCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Original permissions:', formData.permissions)
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div>
            ...
            <input
              ...
              className={`block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${validationErrors.name
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${validationErrors.level
                ? 'border-red-300 bg-white text-gray-900'
                : 'border-gray-300 bg-white text-gray-900 placeholder-gray-500'
                }`}
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleInputChange}
            className={`block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${validationErrors.description
              ? 'border-red-300 bg-white text-gray-900'
              : 'border-gray-300 bg-white text-gray-900 placeholder-gray-500'
              }`}
        ...
        <div>
          ...
          <div className="border rounded-lg p-4 max-h-96 overflow-y-auto border-gray-300 bg-gray-50">
            {modulesData.map((module, moduleIndex) => (
              <div key={`module-${module.module}-${moduleIndex}`} className="mb-4 last:mb-0">
                {/* Module Header */}
                ...
                {expandedModules[module.module] && (
                  <div className="ml-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                    {module.actions.map((action, actionIndex) => {
                      ...
                      return (
                        <div key={`action-${module.module}-${action}-${actionIndex}`} className="flex items-center">
                          <input
                            type="checkbox"
                            id={permission}
                            checked={isChecked}
          ...
          {selectedPermissions.size > 0 && (
            <div className="mt-4 p-3 rounded-md bg-blue-50 border border-blue-200">
              ...
              <div className="mt-2 flex flex-wrap gap-1">
                {Array.from(selectedPermissions).map((permission, permIndex) => (
                  <span
                    key={`selected-permission-${permission}-${permIndex}`}
        ...
        <div className="flex justify-end space-x-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`px-6 py-2 bg-blue-600 text-white rounded-md font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors ${loading ? 'opacity-50 cursor-not-allowed' : ''
              }`}
          >
            {loading ? (
              <div className="flex items-center">
