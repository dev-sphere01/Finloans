...
const getAllStructure = async (query = null, pageNumber = 1, pageSize = 5, obStatus = null, isActive = null, columnFilters = [], sorting = []) => {
  try {
    ...
    const response = await API.get('/SalaryStructures', payload);
...
export default GetAllSalaryStructure;